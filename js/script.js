const ApiKey = "fdef87491edf43cdb72de27aa884662d";
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <li class="collection-item avatar">
                    ...
                    <a href="#modal1" data-id="${team.id}" class="secondary-content"><i class="material-icons"data-id="${team.id}">info</i></a>
                </li>
                `
            });
...
function showTeamInfo(id) {
     ...
     fetch(id, fetchHeader)
         ...
         .then(resJson => {
             ShowModal.innerHTML=`
             <center>
             <h3>Informasi Detail Tim </h3>
             </center>
                 <div class="modal-content">
                     <div class="modal-body" id="">
                     <center>
                     <img src = ${resJson.crestUrl}></img>
                         <h4>${resJson.name}</h4>
                         <p>
